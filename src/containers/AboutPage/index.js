...
const data = [
  {
    team: '發起團隊',
    name: 'RE-THINK\n社團法人台灣重新思考環境教育協會',
    intro: 'RE-THINK的目標就是解決台灣爆量的垃圾問題，身為本土最具社群號召力的環保團體，我們從2013年開始，RE-THINK 帶領群眾在全台灣淨灘。\n在全台海灘撿越久的垃圾，才發現牽連到的問題越多。所以，我們製作[《海廢圖鑑》](https://oceantrash.rethinktw.org/)，用最ㄎㄧㄤ的方式把全台灣的海洋廢棄物搜集成網站，讓大家重新認識海洋廢棄物。但光了解海廢還不夠，我們生活中每天都製造了源源不絕的垃圾，其中更有不少垃圾沒有妥善被處理。於是讓大家懂分、懂丟的《回收大百科》就這麼誕生了！在大家輕鬆查找回收資訊的背後，RE-THINK 團隊努力每年更新資訊和回收物，盡可能讓大家找到最正確、最即時的分類資訊，展開每天的永續行動。',
  ...
  return (
    <Box pt={responsive('3.5em', '3.5em')} bg="colors.yellow">
      ...
      <Box bg="white" pt="5em">
        ...
        {data.map(({ team, name, intro, logo, url, donate }, i) => (
          <Flex
