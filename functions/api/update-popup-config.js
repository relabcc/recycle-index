/**
 * Cloudflare Pages Function for updating popup configuration
 */
...
export async function onRequest(context) {
  ...
  try {
    ...
    // Check if user is authorized (you should store this in environment variables)
